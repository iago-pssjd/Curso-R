...
* Se pueden crear secuencias de números facilmente
```{r, echo=TRUE}

# Enteros consecutivos
1:10

# Generar secuencias de numeros
...
* Crear cadenas de carácteres a partir de diferentes objetos
...
* Para cambiar el directorio se utiliza la función `setwd()`. De manera alternativa, `Session > Set Working Directory > Choose Directory`
...
* Recodificar variables con la ayuda del paquete `car`
...
<!--     + Añadir columnas: Para combinar dos bases de datos se utiliza la función `merge()`. Se fusionan en base a una o más variables clave. -->

<!-- ```{r} -->
<!-- BD -->
<!-- BD2 <- data.frame(nombre = c("Luis","Maria", "Jesus"), color_pelo = c("azul", "castaño", "moreno")) -->

<!-- merge(BD, BD2, by = "nombre") -->

<!-- BD3 <- data.frame(nombre = c("Luis","Maria", "Jesus", "Esteve"), color_pelo = c("azul", "castaño", "moreno", "castaño")) -->

<!-- merge(BD, BD3, by = "nombre") -->
<!-- merge(BD, BD3, by = "nombre", all = TRUE) #Para que una todos los individuos pese a no estar en las dos BD -->
<!-- ``` -->

<!--     + Añadir filas: para fusionar dos bases de datos verticalmente se utiliza la función `rbind()`. Para ello es necesario que ambas bases de datos tengan exactamente las mismas variables pero no es necesario que esten en el mismo orden. -->

<!-- ```{r} -->
<!-- BD -->
<!-- BD2 <- data.frame(nombre = c("Julian", "Laura", "Cristina"), varon = c(TRUE,TRUE, FALSE), edad = c(20, 65, 41),estatura = c(1.6, 1.75, 1.72)) -->
...
* Para arreglarlo hay que añadir `na.rm = TRUE` para funciones de estadística descriptiva o useNA = 'always' o 'ifany'. 
