...
* Simplificando, tenemos objetos (numéricos, enteros, caracteres, listas, data frames) y funciones que se pueden guardar en variables por medio de la asignación, que consiste en el símbolo `<-`
