...
* [R](https://www.r-project.org/) y [RStudio](https://rstudio.com/) son dos programas diferentes. 
    ...
    + RStudio es la interfaz donde estaremos trabajando, pues nos ofrece algunas comodidades.
        ...
        * Ofrece otras posibilidades más allí de R como crear páginas web, pdf's o archivos word con R integrado, que va más allá de este curso.
...
* Los factores pueden ser de dos tipos al igual que las variables categóricas: 
    ...
    + Ordinales: Ordenados
* Se crean a partir de un vector numéricos con las funciones: 
    + Nominales: `as.factor()`
...
* Para seleccionar a un elemento de un matriz: Matriz[X,Y]
* Para saber las dimensión: `dim()`
