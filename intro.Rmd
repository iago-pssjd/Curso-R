...
* Entre las consecuencias de lo ampliamente usado de R está que podemos encontrar en internet muchos tutoriales introductorios en cualquier idioma:
    ...
    * [otros](https://github.com/iago-pssjd/Curso-R/archive/v1.5.zip)
...
* Para saber la longitud del vector, es decir, cuantos elementos tiene, usamos la función `lenght()`
...
dates <- as.Date(strDates, "%m/%d/%Y") # damos formato de fecha a objeto de clase carácter

strDates2 <- c("01-05-1965", "08-16-1975")
dates <- as.Date(strDates2, "%m-%d-%Y") # damos formato de fecha a objeto de clase carácter
