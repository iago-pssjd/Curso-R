...
- **Fechas/Horas**: hay 2 representaciones principales (ejecutando `?DateTimeClasses` puede verse más información)
    + vectores de tipo numérico (o entero), representando el número de segundos desde 1970-01-01 UTC, con clase `POSIXct`
...
Cuando hay más de un conjunto de columnas que queremos pivotar, como en este caso, en el que tenemos por un lado `hea1`, `hea2` y `hea3` y por otro lado, `dep2` y `dep3`, son necesarias las expresiones regulares.
