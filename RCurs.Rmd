...
dataw1 %>% #partimos de la base de datos dataw1 y entonces
  ...
  summarise(mean_hea1 = mean(hea1, na.rm = TRUE), median_hea1 = median(hea1, na.rm = TRUE), tercil_hea1 = quantile(hea1, probs = 1/3, na.rm = TRUE), n = n()) # para cada categoría de depresión calculamos media, mediana y primer tercil de hea1, y número de observaciones
